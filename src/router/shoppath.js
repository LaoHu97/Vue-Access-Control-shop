...
export default [{
  ...
  },
  {
    ...
    children: [{
      ...
      component: (resolve) => require(['../views/shop/nav11/shop1.vue'], resolve)
    }, {
      path: 'shop2-v',
      name: '订单管理 ',
      meta: {
      ...
      component: (resolve) => require(['../views/shop/nav11/shop2.vue'], resolve)
    }]
  },
  {
    path: '/index4',
