...
<section>
  ...
  <el-row>
    <el-form :inline="true" :model="filters">
      ...
      <el-form-item label="余额变动">
        <template>
						<el-select v-model="filters.transType" class="fixed_search_input" clearable placeholder="余额变动">
							<el-option label="存入" value="IN"></el-option>
      ...
      <el-form-item label="交易状态">
        <template>
					  <el-select v-model="filters.status" class="fixed_search_input" clearable placeholder="交易状态">
					    <el-option
  ...
  <el-table :data="users" border highlight-current-row style="width: 100%;">
    ...
    <el-table-column prop="reason_id" label="交易类型" :formatter="reason_idformatter">
    </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryMemBalanceList(para).then((res) => {
        this.total = res.data.total;
        this.users = res.data.balTransList;
