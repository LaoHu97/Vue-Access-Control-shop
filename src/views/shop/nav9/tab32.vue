	...
	<section>
		...
		<div v-loading="listLoading">
			<el-table :data="users" highlight-current-row style="width: 100%;" border>
				...
				<el-table-column prop="surplus_total" label="核销次数">
				</el-table-column>
				<el-table-column prop="use_time" label="核销统计日期">
				</el-table-column>
			</el-table>
		</div>
...
<script>
	...
	//
	import { queryConsumeFrequencyCountList, exportConsumeCountList } from '../../../api/shop';
	export default {
		data() {
			return {
				filters: {
        ...
        para.endTime = para.queryDate[1].toString()
        delete para.queryDate
				queryConsumeFrequencyCountList(para).then((res) => {
