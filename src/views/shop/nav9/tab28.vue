	...
	<section>
		...
		<div v-loading="listLoading">
			<el-table :data="users" highlight-current-row style="width: 100%;" border>
				...
				<el-table-column prop="summary_count" label="总数">
				</el-table-column>
				<el-table-column prop="consume_count" label="领取总数">
				</el-table-column>
				<el-table-column prop="count_time" label="统计日期">
				</el-table-column>
			</el-table>
		</div>
...
<script>
	...
	//
	import { getQueryConsumeCountList, exportConsumeCountList } from '../../../api/shop';
	export default {
		data() {
			return {
				filters: {
        ...
        para.endTime = para.queryDate[1].toString()
        delete para.queryDate
				getQueryConsumeCountList(para).then((res) => {
					this.total = res.data.total;
					this.users = res.data.queryConsumeCountList;
