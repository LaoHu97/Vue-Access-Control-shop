...
<script>
  ...
  import { uploadAgentImage, addWdMiniInfo, selectInfoByMid, queryWdMiniMenu, addMiniMenu, deleteWdMiniMenu, updateMiniMenu } from '../../../api/shop';
  export default {
    data() {
      return {
        uploadimg: uploadAgentImage,
        filters: {
          appid: '',
          title: ''
        },
