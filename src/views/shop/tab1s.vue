  ...
  <el-col :span="16">
    ...
    <el-form :model="form_01" :rules="form_01Rules" ref="form_01" label-width="100px" @submit.prevent="onSubmit" label-position="left" style="padding:0 0 0 55px;width:700px;background-color:#F9FAFC;border: 1px solid #e7e7eb" v-show="formDate1">
      ...
      <el-form-item label="折扣率" prop="discount" style="width:600px;">
        <el-input v-model="form_01.discount" placeholder="0~100之间的整数" :maxlength="3" style="width:200px;"></el-input>
        <span style="color:#999"><i class="el-icon-information"></i>会员卡享受的折扣优惠,填10就是九折</span>
      </el-form-item>
      ...
      <el-form-item label="余额类目URL" style="width:500px;"  v-if="this.license=='N'&&this.form_01.supply_balance">
        <template>
      ...
      <el-form-item label="其它类目URL" style="width:500px;"  v-if="this.license=='N'&&this.form_01.supply_balance">
        <template>
    ...
    <el-form ref="form_04" :model="form_04" label-width="100px" @submit.prevent="onSubmit" label-position="left" style="padding:0 0 0 55px;width:700px;float:left;background-color:#F9FAFC;border: 1px solid #e7e7eb" v-show="formDate4">
      ...
      <el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="20" :total="total" style="float:right;padding-right:70px;"></el-pagination>
    </el-form>
    <!-- 表单05 -->
