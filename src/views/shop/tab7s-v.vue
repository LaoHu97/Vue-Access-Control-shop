        ...
        this.$refs.form_02.validate((valid) => {
          this.$refs.form_03.validate((valid) => {
            if (valid) {
              ...
              para.card_type = para.card_type == '1' ? 'GROUPON' : para.card_type == '2' ? 'CASH' : para.card_type == '3' ? 'DISCOUNT' : para.card_type == '4' ? 'GIFT' : para.card_type == '5' ? 'GENERAL_COUPON' : para.card_type == '6' ? 'FREQUENCY': para.card_type == '7' ? 'WDGIFT_COUPON' : 'weizhi';
