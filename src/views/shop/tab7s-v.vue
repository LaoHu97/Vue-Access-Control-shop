      ...
      >
        ...
        <el-form-item label="有效期">
          <template>
            ...
            <div v-else>
              <el-input
                v-model="form_01.fixed_begin_term"
          ...
          <template>
            ...
            <div v-if="form_01.time_limit == '1'">
              ...
              <div style="margin-bottom: 5px" v-if="hour_minute">
                ...
                <el-time-select
                  placeholder="结束时间"
                  v-model="end_hour_minute_1"
                  :picker-options="{
                  start: '00:00',
                  step: '00:10',
                  end: '24:59',
                  minTime: begin_hour_minute
                }"
                ></el-time-select>
              </div>
        ...
        <el-form-item label="房间类型" prop="roomType" v-if="card_type === '1'">
          <el-select v-model="form_01.roomType" multiple placeholder="请选择">
            <el-option v-for="item in roomTypeOptions" :key="item.roomType" :label="item.roomType" :value="item.roomType"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item
          :label="card_type_label01"
          prop="least_cost"
          style="width:300px;"
          v-if="least_cost_show"
        >
          ...
          this.$refs.form_03.validate(valid => {
            if (valid) {
              let para = {
                ...
                roomType: this.form_01.roomType,
                time_limit: this.form_01.time_limit,
                week: this.form_01.week,
                begin_hour_minute_1: this.begin_hour_minute_1,
                end_hour_minute_1: this.end_hour_minute_1,
                begin_hour_minute_2: this.begin_hour_minute_2,
                end_hour_minute_2: this.end_hour_minute_2,
