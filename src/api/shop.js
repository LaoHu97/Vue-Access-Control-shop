...
小程序管理
*/
export const addWdMiniInfo = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/addWdMiniInfo`,params).then(res => res.data); };

export const queryWdMiniInfo = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/queryWdMiniInfo`,params).then(res => res.data); };

export const deleteWdMiniInfo = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/deleteWdMiniInfo`,params).then(res => res.data); };

export const selectInfoByMid = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/selectInfoByMid`,params).then(res => res.data); };

export const queryWdMiniMenu = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/queryWdMiniMenu`,params).then(res => res.data); };

export const updateMiniInfo = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/updateMiniInfo`,params).then(res => res.data); };

export const addMiniMenu = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/addMiniMenu`,params).then(res => res.data); };

export const deleteWdMiniMenu = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/deleteWdMiniMenu`,params).then(res => res.data); };

export const updateMiniMenu = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/updateMiniMenu`,params).then(res => res.data); };

export const addMiniNews = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/addMiniNews`,params).then(res => res.data); };

export const selectByTime = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/selectByTime`,params).then(res => res.data); };

export const deleteMiniNews = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/deleteMiniNews`,params).then(res => res.data); };

export const updateMiniNews = params => { return instance.post(`${preUrlPath}/admin/wp/mer/mini/1/updateMiniNews`,params).then(res => res.data); };
